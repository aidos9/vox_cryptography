// Sourced from https://www.schneier.com/wp-content/uploads/2015/12/constants-2.txt

pub const BLOWFISH_KEY_MIN: usize = 32 / 8;
pub const BLOWFISH_KEY_MAX: usize = 448 / 8;

pub const BLOWFISH_P_ARRAY: [u32; 18] = [
    0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0, 0x082efa98, 0xec4e6c89,
    0x452821e6, 0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917,
    0x9216d5d9, 0x8979fb1b,
];

pub const BLOWFISH_S_BOXES: [[u32; 256]; 4] = [
    [
